...
require_once $_SERVER['DOCUMENT_ROOT'] . $app_root . "/models/AbstractBlogPost.php";
require_once $_SERVER['DOCUMENT_ROOT'] . $app_root . "/models/BlogpostImage.php";
require_once $_SERVER['DOCUMENT_ROOT'] . $app_root . "/models/BlogpostVideo.php";
...
require_once $_SERVER['DOCUMENT_ROOT'] . $app_root . "/services/BlogServiceInterface.php";
require_once $_SERVER['DOCUMENT_ROOT'] . $app_root . "/services/JsonBlogService.php";
require_once $_SERVER['DOCUMENT_ROOT'] . $app_root . "/services/DbBlogService.php";
...
$container = new Container( $logfile, $dbconfig, $jsonfile );
